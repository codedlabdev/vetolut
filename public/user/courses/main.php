...
<div class="courses-container">
    ...
    <div style="display: none;" class="row g-3 mb-4">
        <div class="col-6">
    ...
    <div class="categories-section mb-4">
        ...
        <div class="filter-pills mb-4">
            <div class="d-flex gap-2 overflow-auto pb-2 hide-scrollbar">
                <span class="badge rounded-pill border border-primary text-primary px-3 py-2 flex-shrink-0">Explore Couses</span>
                <span class="badge rounded-pill border border-primary text-primary px-3 py-2 flex-shrink-0">My Learning</span>
                                ...
                                <div class="col-md-4 col-lg-3 mb-3 mb-md-0">
                                    <div class="position-relative">
                                        ...
                                        <div class="course-image-wrapper">
                                            <a href="<?php echo BASE_URL; ?>public/user/courses/details.php?id=<?php echo $course['id']; ?>">
