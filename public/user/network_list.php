...
$posts = fetchPosts($limit, $offset); // Get the first 10 posts
...
<?php else: ?>
    ...
    <div class="post-content">
        ...
        <div class="post-content">
            ...
            <?php if (!empty($post['photo'])): ?>
                ...
                <?php if (!empty($post['image_count']) && $post['image_count'] > 1): ?>
                <span class="image-count-label"><?php echo $post['image_count']; ?> Images</span>
                <style>
                .image-count-label {
                        top: 50px;
            ...
            <?php else: ?>
                <img src="https://via.placeholder.com/600x400.png?text=No+Image" alt="Placeholder Image" class="post-img">
            <?php endif; ?>
        </div>
    ...
    <!-- Load More Button -->
    <button id="load-more" class="post" style="width: 100%;" onclick="loadMorePosts()">Load More</button>
<?php endif; ?>
...
$suggestedUsers = getSuggestedUsers($loggedInUserId);
    ...
    ?>
               <div class="suggestion">
                ...
                <?php endforeach; ?>
				<p></p>
				<button class="post" style="width: 100%;" onclick="window.location.href='<?php echo BASE_URL; ?>user/contact_list.php'">
					List More
				</button>
