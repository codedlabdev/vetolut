...
include '../header.php';
require_once BASE_DIR . 'lib/user/pass_upd.php';
...
<div id="P_MessageContainer" class="message" style="text-align: center;">
    <?php if ($message): ?>
...
<div class="appointment-upcoming d-flex flex-column vh-100">
    ...
    <div class="d-flex align-items-center justify-content-between mb-auto p-3 bg-white shadow-sm osahan-header">
        ...
        <h6 class="mb-0 ms-3 me-auto fw-bold">Update Password</h6>
            ...
            <form id="passwordForm" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group border bg-white rounded-3 py-1">
                        <input style="padding-left: 15px !important;" type="password" name="old_password" class="form-control bg-transparent rounded-0 border-0 px-0" placeholder="Old Password" required>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group border bg-white rounded-3 py-1">
                        <input style="padding-left: 15px !important;" type="password" name="new_password" class="form-control bg-transparent rounded-0 border-0 px-0" placeholder="New Password" required>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group border bg-white rounded-3 py-1">
                        <input style="padding-left: 15px !important;" type="password" name="confirm_password" class="form-control bg-transparent rounded-0 border-0 px-0" placeholder="Confirm Password" required>
                    </div>
                </div>

                <!-- Submit Button -->
                <button type="submit" onclick="updatePassword(); return false;" class="btn btn-info rounded-4" style="position: absolute; margin-left: 20px; width: 80%;">Save Changes</button>
